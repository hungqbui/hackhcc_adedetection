import { Contrast, User, Phone, ShieldCheck, Activity, Bell, Trash2 } from 'lucide-react'
...
export default function ProfileSettings({ accessibility, onToggleAccessibility }: ProfileSettingsProps) {
  const resetAllData = () => {
    ...
    <div className="max-w-2xl mx-auto pb-16 space-y-8">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
          Manage your profile, accessibility preferences, and data.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800">
          <h2 className="font-bold text-slate-900 dark:text-white text-base">Patient Profile</h2>
        </div>
        <div className="px-6">
          {row('Patient Name', <span className="text-sm font-semibold text-slate-800 dark:text-white">Alex Johnson</span>, <User size={15} />)}
          {row('Emergency Contact', <span className="text-sm font-semibold text-blue-600 dark:text-blue-400">+1 (555) 321-7654</span>, <Phone size={15} />)}
          {row('AI Warning Sensitivity', (
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800">
          <h2 className="font-bold text-slate-900 dark:text-white text-base">Accessibility</h2>
          <p className="text-xs text-slate-400 mt-0.5">Adjust display settings for better readability.</p>
        </div>
        <div className="px-6">
